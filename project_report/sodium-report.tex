...
\supervisor{Dr Martinez-Canales} % Place your principal supervisor here
...
This allows for a much sparser Fourier grid to approximate the wavefunctions, as they have less high-frequency components.
...
Another type of pseudopotential, the ultrasoft pseudopotential \cite{vanderbilt1990soft} does not satisfy this norm-conserving condition. They relax this to allow a smaller wavefunction basis set to be used, and instead change the eigenvalues of the Kohn-Sham pseudo-Hamiltonian.
