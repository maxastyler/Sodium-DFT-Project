...
\end{equation}
Where the sum is over all unit cell vectors. This dynamical then gives an eigenvalue equation for the phonon frequencies and directions:
...
Another type of pseudopotential, the ultrasoft pseudopotential \cite{vanderbilt1990soft} does not satisfy this norm-conserving condition. They relax on this condition to allow a smaller wavefunction basis set to be used, and instead change the eigenvalues of the Kohn-Sham pseudo-Hamiltonian.
